...
//Fog
const fogscene = new THREE.Fog('#262837', 1, 10)
scene.fog = fogscene
...
//Color
debugObject.depthColor = '#064273'
debugObject.surfaceColor = '#7fcdff'
...
gui.add(waterMaterial.uniforms.uBigWavesSpeed, 'value').min(0).max(5).step(0.001).name('BigWavesSpeed')
...
gui.add(waterMaterial.uniforms.uSmallWavesFrequency.value, 'x').min(0).max(10).step(0.001).name('SmallWavesFrequencyX')
gui.add(waterMaterial.uniforms.uSmallWavesFrequency.value, 'y').min(0).max(10).step(0.001).name('SmallWavesFrequencyY')
gui.add(waterMaterial.uniforms.uSmallWavesSpeed, 'value').min(0).max(5).step(0.001).name('SmallWavesSpeed')
